...
<form action="<?php echo JRoute::_('index.php?option=com_warranty&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="product-form" class="form-validate">
        ...
        <div class="row-fluid">
            <div class="row-fluid">
                <div class="span6">
                    ...
                    <?php foreach ($this->form->getFieldset('shop_info') as $field) :?>
                ...
                <div class="span6">
                    ...
                    <?php foreach ($this->form->getFieldset('customer_info') as $field) :?>
                        <div class="control-group">
                            <div class="control-label"><?php echo $field->label; ?></div>
                            <div class="controls"><?php echo $field->input; ?></div>
                        </div>
            ...
            <div class="row-fluid">
                ...
                <div class="span6">
                    <?php foreach ($this->form->getFieldset('product_info') as $field) :?>
                        <div class="control-group">
                            <div class="control-label"><?php echo $field->label; ?></div>
                            <div class="controls"><?php echo $field->input; ?></div>
                        </div>
