...
<form action="<?php echo JRoute::_('index.php?option=com_warranty&view=shops'); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
		...
		<table class="table table-striped" id="productList">
			<thead>
				<tr>
					...
					<th>
						<?php echo JHtml::_('grid.sort', 'COM_WARRANTY_ADDRESS', 'a.address', $listDirn, $listOrder); ?>
					</th>
					<th>
						<?php echo JHtml::_('grid.sort', 'COM_WARRANTY_PHONE', 'a.phone', $listDirn, $listOrder); ?>
					</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td><a href="<?php echo JRoute::_('index.php?option=com_warranty&task=shop.edit&id='.(int) $item->id); ?>"><?php echo $item->name; ?></a></td>
