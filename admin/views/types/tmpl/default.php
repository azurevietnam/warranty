...
<form action="<?php echo JRoute::_('index.php?option=com_warranty&view=types'); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
		...
		<table class="table table-striped" id="productList">
			<thead>
				<tr>
                    ...
                    <th>
                        <?php echo JHtml::_('grid.sort', 'COM_WARRANTY_NAME', 'a.name', $listDirn, $listOrder); ?>
                    </th>
					<th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td><a href="<?php echo JRoute::_('index.php?option=com_warranty&task=type.edit&id='.(int) $item->id); ?>"><?php echo $item->code; ?></a></td>
                    ...
                    <td>
                        <?php if($item->images && $item->images->get('image_intro')){?>
                            ...
                            <img src="<?php echo JUri::root().$item->images->get('image_intro');?>" alt="<?php echo $item->images->get('image_intro_alt');?>" style="height: 50px"/>
                            </a>
                        <?php }?>
                    </td>
