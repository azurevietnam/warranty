 ...
 */
class WarrantyViewTypes extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        WarrantyHelper::addSubmenu('types');
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_WARRANTY_TITLE_MODELS'), 'palette');
        ...
        JHtmlSidebar::setAction('index.php?option=com_warranty&view=types');
