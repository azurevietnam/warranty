...
<form action="<?php echo JRoute::_('index.php?option=com_warranty&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="type-form" class="form-validate">
